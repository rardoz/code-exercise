...
export const SCORE_WINNING = 2;
export const SCORE_INCREMENT = 1;

export const SPEED_INITIAL = 1;
export const SPEED_INCREMENT = 1;

export const BOARD_WIDTH = '95%';
export const BOARD_HEIGHT = '95%';

export const ICON_WIDTH = 50;
export const ICON_HEIGHT = 50;
export const ICON_X_INITIAL = 50;
export const ICON_Y_INITIAL = 50;

export const DRAW_RATE = 35;
